...
import { MytradesComponent } from './trade/mytrades/mytrades.component';
...
const routes: Routes = [
  ...
  { path: 'create-trade', component: CreateTradeComponent ,canActivate: [AuthGuard]},
  { path: 'mytrades/:tradeId', component: TradeDetailsComponent ,canActivate: [AuthGuard]},
  { path: 'mytrades/edit/:tradeId', component: CreateTradeComponent, canActivate: [AuthGuard] },
